...
case class GeneratedEnumField(name: Identifier, constant: Int, parent: Identifier) {
  lazy val generate: String = {
    val capitalizedName = name.generate.toLowerCase.capitalize
    s"""case object ${capitalizedName} extends ${parent.generate} {val identifier = ${constant}; val name = "${capitalizedName}"}"""
  }
}
...
case class GeneratedEnumeration(
  ...
  lazy val generate = s"""sealed trait ${name.generate} {val identifier: Int; val name: String} \n
